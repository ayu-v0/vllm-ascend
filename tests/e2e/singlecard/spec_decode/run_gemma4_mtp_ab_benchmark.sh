...
MAX_NUM_SEQS=${VLLM_ASCEND_GEMMA4_MTP_AB_MAX_NUM_SEQS:-16}
...
NUM_PROMPTS=${VLLM_ASCEND_GEMMA4_MTP_AB_NUM_PROMPTS:-500}
INPUT_LEN=${VLLM_ASCEND_GEMMA4_MTP_AB_INPUT_LEN:-12500}
OUTPUT_LEN=${VLLM_ASCEND_GEMMA4_MTP_AB_OUTPUT_LEN:-1024}
MAX_CONCURRENCY=${VLLM_ASCEND_GEMMA4_MTP_AB_MAX_CONCURRENCY:-16}
